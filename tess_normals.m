...
% Display warning
if (nBadWarning > 0)
    disp(sprintf('BST> Warning: Normals could not be calculated for %d vertices. Right-click on the surface and select "Clean surface" to remove those vertices.', nBadWarning));
end
